...
function load_assets()
{
	...
	// Load scripts
	wp_enqueue_script('fisher-scripts', get_template_directory_uri() . '/dist/js/build.js', array('jquery', 'jquery-ui-draggable'), '1.0.0', true);
}
...
{
	$columns['is_featured'] = __('Has page?');
	return $columns;
}

function smashing_project_column($column, $post_id)
{
	// Image column
...
function smashing_project_sortable_columns($columns)
{
...
add_filter('manage_project_posts_columns', 'smashing_filter_posts_columns');
add_action('manage_project_posts_custom_column', 'smashing_project_column', 10, 2);
add_filter('manage_edit-project_sortable_columns', 'smashing_project_sortable_columns');
